...
export const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_g2e8t0d",     // 🔁 Replace this
        "template_reh12kb",    // 🔁 Replace this
        formRef.current,
        "0qvjAw1WvBseU1OUe"      // 🔁 Replace this
      )
      .then(
        () => {
          toast({
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:anshimasinghask@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    anshimasinghask@gmail.com
                  </a>
                </div>
              </div>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Anshima Singh Kushwah"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:ring-2 focus:ring-primary"
                  placeholder="anshimasinghask@gmail.com"
                />
              </div>
